...
export function ReviewCard({ rating, comment, author = "Usuario" }) {
  return (
...
const styles = StyleSheet.create({
  ...
  rating: { flexDirection: "row", gap: spacing.xs },
  comment: { fontSize: 13, lineHeight: 18, color: colors.textSecondary },
});
